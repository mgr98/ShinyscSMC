...
rsconnect::setAccountInfo(name='mgr98',
                          token='4806C7618BE707D105B87BD067ADA12C',
                          secret='RuTo85/nGN5K1GKsiEt3dy3aPh1UZF8p5OOeCPbs')

rsconnect::deployApp('/Users/miguel/Desktop/Shiny')

# Some initial setup:
# take in the file, get list of genes, get metadata numbers and categories, get pcs 1-9, and factors..
aggregate <- readRDS('AllTimePoints.rds')
